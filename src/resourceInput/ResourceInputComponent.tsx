...
const ResourceInputComponentUI: React.StatelessComponent<ResourceInputComponentUIProps> = 
({values, handleAddResource, handleChangeResource, handleChangeCount, handleDelete}) => 
(
<div>
    <div>
